...
var fileDescriptor_92abfd958a095a85 = []byte{
	...
	0x86, 0x52, 0x38, 0x34, 0x14, 0xa5, 0x16, 0x96, 0xa6, 0x16, 0x97, 0x40, 0x34, 0x18, 0xcd, 0x62,
	...
	0x1c, 0x66, 0x8a, 0x1c, 0x2e, 0x69, 0xa8, 0x61, 0xf6, 0x5c, 0x2c, 0xc1, 0x99, 0xe9, 0x79, 0xa8,
	0xbe, 0xf0, 0x4b, 0x2d, 0x07, 0x09, 0x62, 0xf5, 0x05, 0x5c, 0x0e, 0x62, 0x80, 0x93, 0xcb, 0x89,
	0x47, 0x72, 0x8c, 0x17, 0x1e, 0xc9, 0x31, 0x3e, 0x78, 0x24, 0xc7, 0x38, 0xe1, 0xb1, 0x1c, 0xc3,
	0x85, 0xc7, 0x72, 0x0c, 0x37, 0x1e, 0xcb, 0x31, 0x44, 0x69, 0xa5, 0x67, 0x96, 0x64, 0x94, 0x26,
	0xe9, 0x25, 0xe7, 0xe7, 0xea, 0x57, 0xe5, 0xe7, 0xa5, 0x24, 0x56, 0xe8, 0x63, 0x09, 0xed, 0x92,
	0xca, 0x82, 0xd4, 0xe2, 0x24, 0x36, 0x70, 0x48, 0x1b, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x06,
	0x8d, 0x16, 0x6b, 0xc1, 0x01, 0x00, 0x00,
}
...
type KeyringServiceClient interface {
	...
	Sign(ctx context.Context, in *NewSignRequest, opts ...grpc.CallOption) (*NewSignResponse, error)
}
...
func (c *keyringServiceClient) Sign(ctx context.Context, in *NewSignRequest, opts ...grpc.CallOption) (*NewSignResponse, error) {
	out := new(NewSignResponse)
...
type KeyringServiceServer interface {
	...
	Sign(context.Context, *NewSignRequest) (*NewSignResponse, error)
}
...
func (*UnimplementedKeyringServiceServer) Sign(ctx context.Context, req *NewSignRequest) (*NewSignResponse, error) {
...
func _KeyringService_Sign_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KeyringServiceServer).Sign(ctx, req.(*NewSignRequest))
	}
	return interceptor(ctx, in, info, handler)
}
